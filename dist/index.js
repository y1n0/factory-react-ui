...
var shouldForwardProp__default = _interopDefault(shouldForwardProp);
var deepmerge = _interopDefault(require('deepmerge'));
var stylisRTLPlugin = _interopDefault(require('stylis-plugin-rtl'));
...
var VactoryThemeContext = React__default.createContext({
  colorMode: null,
  setColorMode: null
});
var useVactoryTheme = function useVactoryTheme() {
  return React__default.useContext(VactoryThemeContext);
};
...
var getColorsByMode = function getColorsByMode(theme, mode) {
  ...
  var modes = styledSystem.get(theme, 'colors.modes', {});
  return deepmerge.all([{}, _extends({}, theme.colors), _extends({}, styledSystem.get(modes, mode, {}))]);
};
...
var ColorModeProvider = function ColorModeProvider(_ref) {
  ...
  var styledComponentTheme = React.useContext(styled.ThemeContext);
  ...
  return /*#__PURE__*/React__default.createElement(styled.ThemeProvider, {
    theme: theme
  }, /*#__PURE__*/React__default.createElement(VactoryThemeContext.Provider, {
    value: context
  }, children));
};

var DirectionManagerContext = React__default.createContext("ltr");
var DirectionManager = function DirectionManager(_ref) {
  var _ref$dir = _ref.dir,
      dir = _ref$dir === void 0 ? "ltr" : _ref$dir,
      children = _ref.children;
  return /*#__PURE__*/React__default.createElement(DirectionManagerContext.Provider, {
    value: dir
  }, /*#__PURE__*/React__default.createElement(styled.StyleSheetManager, {
...
var StyledChildren = function StyledChildren(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(Fragment, null, styledChildren);
};
...
var PRE = new RegExp("^(" + shouldForwardProp.props.join('|') + ")$");
...
var MRE = new RegExp("^(" + styledSystem.margin.propNames.join('|') + ")$");
...
var SizePropsRegExp = new RegExp("^(" + styledSystem.size.propNames.join('|') + ")$");
...
var LayoutPropsRegExp = new RegExp("^(" + styledSystem.layout.propNames.join('|') + ")$");
...
var SpacePRopsRegExp = new RegExp("^(" + styledSystem.space.propNames.join('|') + ")$");
...
var sx = function sx(props) {
  return css__default(props.sx)(props.theme);
};
var base = function base(props) {
  return css__default(props.__css)(props.theme);
};
var variant = function variant(_ref) {
  var theme = _ref.theme,
      variant = _ref.variant;
  return css__default(css.get(theme, variant))(theme);
};
...
var IntersectionContext = React__default.createContext({
  inView: true
});
var IntersectionObserver = function IntersectionObserver(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(IntersectionContext.Provider, {
    value: {
      inView: inView
    }
...
}, styledSystem.compose(styledSystem.space, styledSystem.color, styledSystem.layout, styledSystem.flexbox, styledSystem.border, styledSystem.typography, styledSystem.boxShadow));
...
var Accordion = React.forwardRef(function (_ref, ref) {
...
var fillVariants = styledSystem.variant({
  scale: 'buttons.fill',
  prop: 'fill',
  variants: {
    primary: {}
...
var PortalContext = React.createContext(undefined);
var ContainerTargetContext = React__default.createContext(typeof document === 'object' ? document.body : undefined);
...
var DropContent = React.forwardRef(function (_ref, ref) {
  var children = _ref.children,
...
var DropContainer = React.forwardRef(function (_ref2, ref) {
  ...
  var portalId = React.useMemo(function () {
    return portalContext.length;
  }, [portalContext]);
  var nextPortalContext = React.useMemo(function () {
  ...
  var content = /*#__PURE__*/React__default.createElement(DropContent, _extends({
    sx: sx,
    ref: ref || dropRef,
    plain: plain,
    elevation: undefined,
  ...
  return /*#__PURE__*/React__default.createElement(PortalContext.Provider, {
    value: nextPortalContext
  }, content);
});
var Drop = React.forwardRef(function (_ref3, ref) {
  ...
  var containerTarget = React.useContext(ContainerTargetContext);
  React.useEffect(function () {
  ...
  return dropContainer ? ReactDOM__default.createPortal( /*#__PURE__*/React__default.createElement(DropContainer, _extends({
    ref: ref,
    dir: theme && theme.dir,
...
var CheckboxIcon = function CheckboxIcon(_ref2) {
  ...
  return /*#__PURE__*/React__default.createElement(Fragment, null, iconName || checkedIconName ? /*#__PURE__*/React__default.createElement(Icon, _extends({
    size: size,
  ...
  })) : /*#__PURE__*/React__default.createElement(CheckboxChecked, _extends({
    size: size
  }, props, {
    __css: {
      display: 'none',
  ...
  })), iconName || uncheckedIconName ? /*#__PURE__*/React__default.createElement(Icon, _extends({
    size: size,
  ...
  })) : /*#__PURE__*/React__default.createElement(CheckboxUnchecked, _extends({
    size: size
  }, props, {
    __css: {
      display: 'block',
...
var Checkbox = React.forwardRef(function (_ref3, ref) {
  ...
  return /*#__PURE__*/React__default.createElement(Box, null, /*#__PURE__*/React__default.createElement(Box, _extends({
    ref: ref,
    as: "input",
    type: "checkbox"
  }, props, {
...
var variantVariants = styledSystem.variant({
...
var variantStatus = styledSystem.variant({
  scale: 'inputs.status',
  prop: 'status',
  variants: {
    primary: {}
...
var variantSizes = styledSystem.variant({
  scale: 'inputs.sizes',
  prop: 'size',
  variants: {
    medium: {
...
var Input = React__default.forwardRef(function (_ref, ref) {
  ...
  }, getMarginProps(props), getLayoutProps(props)), props.icon && /*#__PURE__*/React__default.createElement(Flex, {
    __css: {
      color: 'inherit',
      position: 'absolute',
      width: 'auto',
  ...
  }, props.icon), /*#__PURE__*/React__default.createElement(StyledInput, _extends({
    as: as,
    reverse: reverse,
    size: size
  }, props, {
...
var RadioChecked = function RadioChecked(props) {
  return /*#__PURE__*/React__default.createElement(SVG$1, props, /*#__PURE__*/React__default.createElement("path", {
...
var RadioIcon = function RadioIcon(_ref2) {
  ...
  })) : /*#__PURE__*/React__default.createElement(RadioChecked, _extends({
    size: size
  }, props, {
    __css: {
      display: 'none',
  ...
  })) : /*#__PURE__*/React__default.createElement(RadioUnchecked, _extends({
    size: size
  }, props, {
    __css: {
      display: 'block',
...
var Navs = React.forwardRef(function (_ref, ref) {
  var _ref$variant = _ref.variant,
  ...
  var navs = React.Children.toArray(children).filter(function (child) {
    return child;
  }).map(function (child, index) {
    var nav = React.cloneElement(child, {
...
var itemRender = function itemRender(current, type, element) {
  if (type === 'page') {
    return /*#__PURE__*/React__default.createElement(PaginationPageButton, null, current);
  }

  if (type === 'prev') {
    return /*#__PURE__*/React__default.createElement(PaginationPrevNextButton, null, /*#__PURE__*/React__default.createElement(Icon, {
      size: "14px",
      name: "chevron-left"
    }));
  }
  ...
  if (type === 'jump-prev') {
    return /*#__PURE__*/React__default.createElement(PaginationJumpButton, null, /*#__PURE__*/React__default.createElement(Icon, {
      size: "14px",
      name: "chevrons-left"
    }));
  }
...
var Tabs = React.forwardRef(function (_ref, ref) {
  ...
  var _useState = React.useState(rest.activeTab || 0),
      activeKey = _useState[0],
      setActiveKey = _useState[1];

  var tabRefs = [];
  var headerAnimationCtrls = framerMotion.useAnimation();
  var inkBarAnimationCtrls = framerMotion.useAnimation();
  var motionVariantsContent = {
    active: {
      opacity: [0, 1]
    }
  };
  var headerTabRef = React.useRef(null);
  ...
  }, tabs, showBar && /*#__PURE__*/React__default.createElement(MotionBox, {
    transition: {
      ease: 'easeInOut'
    },
...
var Text = function Text(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(Box, _extends({}, rest, {
    as: as,
    __css: _extends({
      fontSize: 'inherit',
      fontWeight: 'inherit',
...
var StyledLayer = React.forwardRef(function (_ref, ref) {
  var _ref$variant = _ref.variant,
      variant = _ref$variant === void 0 ? 'default' : _ref$variant,
      props = _objectWithoutPropertiesLoose(_ref, ["variant"]);

  var theme = React.useContext(styled.ThemeContext);
  var responsiveBreakpoint = themeGet.themeGet('layer.responsiveBreakpoint', false)({
    theme: theme
  });
  var mediaStyle = {};
  var hidenStyle = {};
  ...
  if (props.responsive && responsiveBreakpoint) {
    mediaStyle["@media (max-width: " + themeGet.themeGet("breakpoints." + responsiveBreakpoint, 0)({
      theme: theme
    }) + " )"] = {
      position: 'absolute',
      width: '100%',
  ...
  return /*#__PURE__*/React__default.createElement(Box, _extends({}, props, {
    ...
    sx: _extends(_extends(_extends({
      position: 'relative',
      zIndex: themeGet.themeGet('layer.zIndex')({
        theme: theme
      }),
      pointerEvents: 'none',
      outline: 'none'
...
var StyledOverlay = function StyledOverlay(props) {
  ...
  return /*#__PURE__*/React__default.createElement(Box, _extends({
    ...
    sx: _extends(_extends({
      position: 'absolute',
      backgroundColor: !props.plain ? themeGet.themeGet('layer.overlay.backgroundColor')({
        theme: theme
      }) : 'transparent',
      top: '0px',
      left: '0px',
...
var KEYFRAMES = {
  ...
  left: {
    vertical: styled.keyframes(_templateObject13()),
    horizontal: styled.keyframes(_templateObject14()),
    "true": styled.keyframes(_templateObject15()),
    "false": styled.keyframes(_templateObject16())
  },
  right: {
    vertical: styled.keyframes(_templateObject17()),
    horizontal: styled.keyframes(_templateObject18()),
    "true": styled.keyframes(_templateObject19()),
    "false": styled.keyframes(_templateObject20())
  },
  start: {
    vertical: styled.keyframes(_templateObject21()),
    horizontal: styled.keyframes(_templateObject22()),
    "true": styled.keyframes(_templateObject23()),
    "false": styled.keyframes(_templateObject24())
  },
  end: {
    vertical: styled.keyframes(_templateObject25()),
    horizontal: styled.keyframes(_templateObject26()),
    "true": styled.keyframes(_templateObject27()),
    "false": styled.keyframes(_templateObject28())
  }
};
...
var POSITIONS = {
  center: {
    vertical: function vertical(bounds) {
      return styled.css(_templateObject31(), bounds.top, bounds.bottom, function (props) {
        return getAnimationStyle(props, 'center', 'vertical');
      });
    },
    horizontal: function horizontal(bounds) {
      return styled.css(_templateObject32(), bounds.left, bounds.right, function (props) {
        return getAnimationStyle(props, 'center', 'horizontal');
      });
    },
    "true": function _true(bounds) {
      return styled.css(_templateObject33(), bounds.top, bounds.bottom, bounds.left, bounds.right, function (props) {
        return getAnimationStyle(props, 'center', 'true');
      });
    },
    "false": function _false() {
      return styled.css(_templateObject34(), function (props) {
  ...
  top: {
    vertical: function vertical(bounds) {
      return styled.css(_templateObject35(), bounds.top, bounds.bottom, function (props) {
        return getAnimationStyle(props, 'top', 'vertical');
      });
    },
    horizontal: function horizontal(bounds) {
      return styled.css(_templateObject36(), bounds.left, bounds.right, bounds.top, function (props) {
        return getAnimationStyle(props, 'top', 'horizontal');
      });
    },
    "true": function _true(bounds) {
      return styled.css(_templateObject37(), bounds.top, bounds.bottom, bounds.left, bounds.right, function (props) {
        return getAnimationStyle(props, 'top', 'true');
      });
    },
    "false": function _false(bounds) {
      return styled.css(_templateObject38(), bounds.top, function (props) {
  ...
  bottom: {
    vertical: function vertical(bounds) {
      return styled.css(_templateObject39(), bounds.top, bounds.bottom, function (props) {
        return getAnimationStyle(props, 'bottom', 'vertical');
      });
    },
    horizontal: function horizontal(bounds) {
      return styled.css(_templateObject40(), bounds.left, bounds.top, bounds.bottom, function (props) {
        return getAnimationStyle(props, 'bottom', 'horizontal');
      });
    },
    "true": function _true(bounds) {
      return styled.css(_templateObject41(), bounds.top, bounds.bottom, bounds.left, bounds.right, function (props) {
        return getAnimationStyle(props, 'bottom', 'true');
      });
    },
    "false": function _false(bounds) {
      return styled.css(_templateObject42(), bounds.bottom, function (props) {
  ...
  left: {
    vertical: function vertical(bounds) {
      return styled.css(_templateObject43(), bounds.top, bounds.bottom, bounds.left, function (props) {
        return getAnimationStyle(props, 'left', 'vertical');
      });
    },
    horizontal: function horizontal(bounds) {
      return styled.css(_templateObject44(), bounds.left, bounds.right, function (props) {
        return getAnimationStyle(props, 'left', 'horizontal');
      });
    },
    "true": function _true(bounds) {
      return styled.css(_templateObject45(), bounds.top, bounds.bottom, bounds.left, bounds.right, function (props) {
        return getAnimationStyle(props, 'left', 'true');
      });
    },
    "false": function _false(bounds) {
      return styled.css(_templateObject46(), bounds.left, function (props) {
  ...
  right: {
    vertical: function vertical(bounds) {
      return styled.css(_templateObject47(), bounds.top, bounds.bottom, bounds.right, function (props) {
        return getAnimationStyle(props, 'right', 'vertical');
      });
    },
    horizontal: function horizontal(bounds) {
      return styled.css(_templateObject48(), bounds.left, bounds.right, function (props) {
        return getAnimationStyle(props, 'right', 'horizontal');
      });
    },
    "true": function _true(bounds) {
      return styled.css(_templateObject49(), bounds.top, bounds.bottom, bounds.left, bounds.right, function (props) {
        return getAnimationStyle(props, 'right', 'true');
      });
    },
    "false": function _false(bounds) {
      return styled.css(_templateObject50(), bounds.right, function (props) {
  ...
  start: {
    vertical: function vertical(bounds) {
      return styled.css(_templateObject51(), bounds.top, bounds.bottom, bounds.start, function (props) {
        return getAnimationStyle(props, 'start', 'vertical');
      });
    },
    horizontal: function horizontal(bounds) {
      return styled.css(_templateObject52(), bounds.start, bounds.end, function (props) {
        return getAnimationStyle(props, 'start', 'horizontal');
      });
    },
    "true": function _true(bounds) {
      return styled.css(_templateObject53(), bounds.top, bounds.bottom, bounds.start, bounds.end, function (props) {
        return getAnimationStyle(props, 'start', 'true');
      });
    },
    "false": function _false(bounds) {
      return styled.css(_templateObject54(), bounds.start, function (props) {
    ...
    vertical: function vertical(bounds) {
      return styled.css(_templateObject55(), bounds.top, bounds.bottom, bounds.end, function (props) {
        return getAnimationStyle(props, 'end', 'vertical');
      });
    },
    horizontal: function horizontal(bounds) {
      return styled.css(_templateObject56(), bounds.start, bounds.end, function (props) {
        return getAnimationStyle(props, 'end', 'horizontal');
      });
    },
    "true": function _true(bounds) {
      return styled.css(_templateObject57(), bounds.top, bounds.bottom, bounds.start, bounds.end, function (props) {
        return getAnimationStyle(props, 'end', 'true');
      });
    },
    "false": function _false(bounds) {
      return styled.css(_templateObject58(), bounds.end, function (props) {
  ...
  'top-right': {
    vertical: function vertical(bounds) {
      return styled.css(_templateObject59(), bounds.top, bounds.bottom, bounds.right, function (props) {
        return getAnimationStyle(props, 'top', 'true');
      });
    },
    horizontal: function horizontal(bounds) {
      return styled.css(_templateObject60(), bounds.left, bounds.right, function (props) {
        return getAnimationStyle(props, 'top', 'true');
      });
    },
    "true": function _true(bounds) {
      return styled.css(_templateObject61(), bounds.top, bounds.bottom, bounds.left, bounds.right, function (props) {
        return getAnimationStyle(props, 'top', 'true');
      });
    },
    "false": function _false(bounds) {
      return styled.css(_templateObject62(), bounds.top, bounds.right, function (props) {
        return getAnimationStyle(props, 'top', 'true');
      });
    }
  },
  'top-left': {
    vertical: function vertical(bounds) {
      return styled.css(_templateObject63(), bounds.top, bounds.bottom, bounds.left, function (props) {
        return getAnimationStyle(props, 'top', 'true');
      });
    },
    horizontal: function horizontal(bounds) {
      return styled.css(_templateObject64(), bounds.left, bounds.right, function (props) {
        return getAnimationStyle(props, 'top', 'true');
      });
    },
    "true": function _true(bounds) {
      return styled.css(_templateObject65(), bounds.top, bounds.bottom, bounds.left, bounds.right, function (props) {
        return getAnimationStyle(props, 'top', 'true');
      });
    },
    "false": function _false(bounds) {
      return styled.css(_templateObject66(), bounds.top, bounds.left, function (props) {
        return getAnimationStyle(props, 'top', 'true');
      });
    }
  },
  'bottom-right': {
    vertical: function vertical(bounds) {
      return styled.css(_templateObject67(), bounds.top, bounds.bottom, bounds.right, function (props) {
        return getAnimationStyle(props, 'bottom', 'true');
      });
    },
    horizontal: function horizontal(bounds) {
      return styled.css(_templateObject68(), bounds.left, bounds.right, bounds.bottom, function (props) {
        return getAnimationStyle(props, 'bottom', 'true');
      });
    },
    "true": function _true(bounds) {
      return styled.css(_templateObject69(), bounds.top, bounds.bottom, bounds.left, bounds.right, function (props) {
        return getAnimationStyle(props, 'bottom', 'true');
      });
    },
    "false": function _false(bounds) {
      return styled.css(_templateObject70(), bounds.bottom, bounds.right, function (props) {
        return getAnimationStyle(props, 'bottom', 'true');
      });
    }
  },
  'bottom-left': {
    vertical: function vertical(bounds) {
      return styled.css(_templateObject71(), bounds.top, bounds.bottom, bounds.left, function (props) {
        return getAnimationStyle(props, 'bottom', 'true');
      });
    },
    horizontal: function horizontal(bounds) {
      return styled.css(_templateObject72(), bounds.left, bounds.right, bounds.bottom, function (props) {
        return getAnimationStyle(props, 'bottom', 'true');
      });
    },
    "true": function _true(bounds) {
      return styled.css(_templateObject73(), bounds.top, bounds.bottom, bounds.left, bounds.right, function (props) {
        return getAnimationStyle(props, 'bottom', 'true');
      });
    },
    "false": function _false(bounds) {
      return styled.css(_templateObject74(), bounds.bottom, bounds.left, function (props) {
        return getAnimationStyle(props, 'bottom', 'true');
      });
    }
  }
...
var StyledContainer = styled__default.div.attrs({
  ...
  return props.plain ? 0 : themeGet.themeGet('layer.borderRadius', 0);
}, function (props) {
  ...
  var responsiveBreakpoint = themeGet.themeGet('layer.responsiveBreakpoint', false)(props);
...
var LayerContainer = React.forwardRef(function (_ref, ref) {
  var children = _ref.children,
      _ref$full = _ref.full,
  ...
  var _useState = React.useState(fullBounds),
  ...
  var content = /*#__PURE__*/React__default.createElement(StyledContainer, _extends({
    ...
    dir: theme.dir
  }), /*#__PURE__*/React__default.createElement(HiddenAnchor, {
    ref: anchorRef,
    tabIndex: "-1",
    "aria-hidden": "true"
  }), children);
  ...
  if (modal) {
    content = /*#__PURE__*/React__default.createElement(StyledLayer, {
      ref: layerRef,
      id: id,
      ...
      tabIndex: "-1",
      dir: theme.dir
    }, /*#__PURE__*/React__default.createElement(StyledOverlay, {
      plain: plain,
  ...
  if (modal) {
    content = /*#__PURE__*/React__default.createElement(FocusedContainer, {
...
var ContainerTargetContext$1 = React__default.createContext(typeof document === 'object' ? document.body : undefined);
var Layer = React.forwardRef(function (props, ref) {
  ...
  var containerTarget = React.useContext(ContainerTargetContext$1);
  React.useEffect(function () {
  ...
  return layerContainer ? ReactDOM.createPortal( /*#__PURE__*/React__default.createElement(LayerContainer, _extends({
    ref: ref
...
var PrevArrow = function PrevArrow(props) {
  return /*#__PURE__*/React__default.createElement(Arrow, _extends({
    sx: {
...
var Slider = React__default.forwardRef(function (_ref2, ref) {
  var children = _ref2.children,
...
var SlideSubtitle = function SlideSubtitle(_ref) {
  ...
  if (typeof subtitle === 'string') {
    return /*#__PURE__*/React__default.createElement(Box, null, subtitle);
  } else {
    return subtitle;
  }
};
...
var SearchOverlayTop = function SearchOverlayTop(_ref) {
  ...
  }, topContent ? topContent : /*#__PURE__*/React__default.createElement(Button, {
  ...
  }, closeIcon ? closeIcon : /*#__PURE__*/React__default.createElement(Icon, {
...
var SearchOverlayContainer = function SearchOverlayContainer(_ref4) {
  ...
  var dir = React__default.useContext(DirectionManagerContext);
  var motionVariants = {
    visible: {
      opacity: 1
    },
  ...
  return /*#__PURE__*/React__default.createElement(MotionFlex, _extends({
    dir: dir,
  ...
  }, /*#__PURE__*/React__default.createElement(SearchOverlayTop, {
    variant: variant + ".",
    topContent: topContent,
    closeIcon: closeIcon,
    onClose: onClose
  }), /*#__PURE__*/React__default.createElement(SearchOverlayForm, {
    onSubmit: handleSubmitForm,
    inputRef: inputRef,
    inputPlaceholder: inputPlaceholder,
    inputTitle: inputTitle
  }), /*#__PURE__*/React__default.createElement(SearchOverlayInfo, {
...
var SearchOverlay = function SearchOverlay(_ref5) {
  ...
  return ReactDOM__default.createPortal( /*#__PURE__*/React__default.createElement(SearchOverlayContainer, _extends({}, rest, {
    open: open
  })), document.body);
};
...
exports.DirectionManagerContext = DirectionManagerContext;
exports.Drop = Drop;
exports.Flex = Flex;
...
exports.ParallaxBox = ParallaxBox;
exports.PrevArrow = PrevArrow;
exports.Radio = Radio;
exports.RevealBox = RevealBox;
exports.Row = Row;
...
exports.TABINDEX_STATE = TABINDEX_STATE;
exports.Tab = Tab;
exports.Tabs = Tabs;
exports.Text = Text;
...
exports.omitSizeProps = omitSizeProps;
exports.omitSpaceProps = omitSpaceProps;
