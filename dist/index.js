...
var useColorModeState = function useColorModeState(theme) {
  ...
  var _useState = React.useState(stored || 'default'),
      mode = _useState[0],
      setMode = _useState[1];
...
var CheckboxIcon = function CheckboxIcon(_ref2) {
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, iconName || checkedIconName ? /*#__PURE__*/React__default.createElement(Icon, _extends({
    size: size,
